...
| `temperature` 原生是上游0.7，为上游沿用，从没测过 | 12 题 × 3 遍量一致率：0.7 是 0.270、0.4 是 0.418、0.2 是 0.479 但回复变长且退化变多，取 0.4。[口径与限制](docs/INTEGRATION.md#74-文本的-temperature-量过稳定性没量过好坏) |
